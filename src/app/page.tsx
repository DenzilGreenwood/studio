          ...
          <div className="container mx-auto px-4">
            <Card className="p-6 mb-12 shadow-lg bg-amber-50 border-amber-300">
              ...
              <CardContent className="px-0 pb-0 text-amber-800 space-y-4">
                 ...
                 <p>
                    This tool is not intended to diagnose, treat, or replace medical or psychological services. All responses are generated by Gemini AI. Please reflect critically and use your own judgment. Thank you for contributing to this study.
                 </p>
              </CardContent>
            </Card>
