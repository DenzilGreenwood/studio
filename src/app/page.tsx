            ...
            <Card className="p-6 mb-12 shadow-lg bg-amber-50 border-amber-300">
              ...
              <CardContent className="px-0 pb-0 text-amber-800">
                 <p>
                    ...
                    You own your data and may delete it at any time from your account settings. This tool is not intended to diagnose, treat, or replace medical or psychological services.
